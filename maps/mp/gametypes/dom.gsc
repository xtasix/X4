...
//	allowed[1] = "hardpoint";
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "defend_assist", level.ex_score_defend_assist );

	maps\mp\gametypes\_rank::registerScoreInfo( "assault", level.ex_score_assault );
	maps\mp\gametypes\_rank::registerScoreInfo( "assault_assist", level.ex_assault_assist );
...
domFlags()
{
	...
	for ( index = 0; index < level.flags.size; index++ )
	{
		...
		domFlag maps\mp\gametypes\_gameobjects::setUseTime( 10.0 * level.fps_multiplier );
