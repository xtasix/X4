...
sabotage()
{
	...
	level.sabBomb.autoResetTime = (60.0 * level.fps_multiplier );
...
onPickup( player )
{
	...
	self.autoResetTime = (60.0 * level.fps_multiplier );
...
resetBombsite()
{
	...
	self maps\mp\gametypes\_gameobjects::setUseTime( level.plantTime * level.fps_multiplier );
...
setUpForDefusing()
{
	...
	self maps\mp\gametypes\_gameobjects::setUseTime( level.defuseTime * level.fps_multiplier );
