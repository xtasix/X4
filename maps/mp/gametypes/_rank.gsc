...
init()
{
	...
	if ( level.teamBased )
	{
		registerScoreInfo( "kill", level.ex_score_kill );
		registerScoreInfo( "headshot", 10 );
		registerScoreInfo( "assist", level.ex_score_assist );
		registerScoreInfo( "suicide", level.ex_score_suicide );
		registerScoreInfo( "teamkill", level.ex_score_teamkill );
	}
	else
	{
		registerScoreInfo( "kill", level.ex_score_kill );
	...
	registerScoreInfo( "win", level.ex_score_win );
	registerScoreInfo( "loss", level.ex_score_loss );
	registerScoreInfo( "tie", level.ex_score_tie );
	registerScoreInfo( "capture", level.ex_score_capture );
	registerScoreInfo( "defend", level.ex_score_defend );
	
	registerScoreInfo( "challenge", level.ex_score_challenge );
