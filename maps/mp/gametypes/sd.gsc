...
onStartGameType()
{
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "win", level.ex_score_win );
	maps\mp\gametypes\_rank::registerScoreInfo( "loss", level.ex_score_loss );
	maps\mp\gametypes\_rank::registerScoreInfo( "tie", level.ex_score_tie );
	...
	maps\mp\gametypes\_rank::registerScoreInfo( "plant", level.ex_score_plant );
...
giveLastAttackerWarning()
{
	...
	while(1)
	{
		...
		wait (interval * level.fps_multiplier );
...
bombs()
{
	...
	for ( index = 0; index < bombZones.size; index++ )
	{
		...
		bombZone maps\mp\gametypes\_gameobjects::setUseTime( level.plantTime * level.fps_multiplier );
...
BombTimerWait()
{
	...
	wait (level.bombTimer * level.fps_multiplier ) ;
}
...
playSoundinSpace( alias, origin )
{
	...
	org.origin = origin;
	org playSound( alias  );
	wait (10 * level.fps_multiplier );  // MP doesn't have "sounddone" notifies =(
	org delete();
}
