...
main()
{
	...
	maps\mp\gametypes\_globallogic::registerTimeLimitDvar( "lts", 10, 0, 1440 );
	maps\mp\gametypes\_globallogic::registerScoreLimitDvar( "lts", 3, 0, 999 );
	maps\mp\gametypes\_globallogic::registerRoundLimitDvar( "lts", 3, 0, 999 );
	maps\mp\gametypes\_globallogic::registerNumLivesDvar( "lts", 1, 0, 1 );
